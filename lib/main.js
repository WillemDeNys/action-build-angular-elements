...
async function run() {
    try {
        ...
        const projectNames = (core.getInput('scan', { required: false }) || '').split(',')
        projectNames = projectNames ? projectNames : undefined
        ...
        function buildMultipleElements(foldersToScan) {
